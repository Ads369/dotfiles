...
local obs_path = os.getenv("OBSIDIAN_PATH")
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd" .. obs_path .. "<cr>", { desc = "navigate to vault" })
--
...
vim.keymap.set("n", "<leader>os",
    ":Telescope find_files search_dirs={\"" .. obs_path .. "notes\"}<cr>")
vim.keymap.set("n", "<leader>oz",
    ":Telescope live_grep search_dirs={\"" .. obs_path .. "notes\"}<cr>")
--
-- search for files in notes (ignore zettelkasten)
-- vim.keymap.set("n", "<leader>ois", ":Telescope find_files search_dirs={\""..obs_path.."notes\"}<cr>")
-- vim.keymap.set("n", "<leader>oiz", ":Telescope live_grep search_dirs={\""..obs_path.."notes\"}<cr>")
--
-- for review workflow
-- move file in current buffer to zettelkasten folder
vim.keymap.set("n", "<leader>ok",
    ":!mv '%:p' " .. obs_path .. "zettelkasten<cr>:bd<cr>")
